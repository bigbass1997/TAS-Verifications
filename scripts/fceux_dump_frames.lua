...
--   Run FCEUX.
--   Open ROM.
--   Open lua script console via File > Lua > New Lua Script Window.
--   Click the Browse button and open this lua file.
--   Click the Run button.
--   Open TAS movie via File > Movie > Play Movie
--   Select the movie file and click OK.
-- This script should restart the game and begin dumping.
-- Once it has advanced to the end of the movie click the Stop button.
-- The dumped inputs should be located next to the original movie file.

-- I am not the author of the following script:
